...
<%@page import="com.dao.BookDaoImpl" import="com.entity.BookDtls"%>
...
<body>
	...
	<!-- illegal access block to admin  module -->
		...
		<tbody>
			...
			<tr>
				...
				<td><a href="edit_books.jsp?id=<%=b.getBookId()%>" class="btn btn-sm btn-primary"><i class="fa-solid fa-pen-to-square"></i>Edit</a><a
					href="../delete?id=<%=b.getBookId()%>" class="btn btn-sm btn-danger ml-1"><i class="fa-solid fa-trash"></i>Delete</a></td>
